<p align="center">
  <img src="https://img.shields.io/badge/AcademIQ-Smart%20Class%20Scheduler-2a542f?style=for-the-badge&labelColor=1c1f17" alt="AcademIQ Badge"/>
</p>

# 🎓 AcademIQ — Smart Class Scheduler
...
- 🏫 **322 Classrooms** tracked across 7 buildings with live status (Available / In Use / Under Capacity / Under Maintenance)
...
| Username | Password |
|----------|----------|
| `ahmed.hassan1@student.ciu.edu.tr` | `ahmed.hassan` |
| `fatima.alzahra2@student.ciu.edu.tr` | `fatima.alzahra` |
| `plamedi.kapuya3@student.ciu.edu.tr` | `plamedi.kapuya` |
| *(367 students total — pattern: `firstname.lastnameN@student.ciu.edu.tr`, password: `firstname.lastname`)* | |

### Instructors
| Username | Password |
|----------|----------|
| `mehmet.kusaf@ciu.edu.tr` | `mehmet.kusaf` |
| `dervis.deniz@ciu.edu.tr` | `dervis.deniz` |
| `melike.direkoglu@ciu.edu.tr` | `melike.direkoglu` |
| *(15 instructors total — pattern: `firstname.lastname`)* | |
