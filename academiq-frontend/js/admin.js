document.addEventListener('DOMContentLoaded', function() {
  ...
  var TABS=[{key:'overview',label:'Dashboard'},{key:'timetables',label:'Timetables'},{key:'instructors',label:'Instructors'},{key:'classrooms',label:'Classrooms'},{key:'exams',label:'Exams'},{key:'feedbacks',label:'Feedbacks'}];
