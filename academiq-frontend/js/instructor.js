document.addEventListener('DOMContentLoaded', function() {
  ...
  var TABS = isAdminView
    ...
    : [{key:'overview',label:'Dashboard'},{key:'timetable',label:'My Schedule'},{key:'availability',label:'Availability'},{key:'students',label:'My Students'},{key:'classrooms',label:'Classrooms'},{key:'exams',label:'Exams'},{key:'feedback',label:'Feedback'},{key:'ai',label:'AI Assistant'}];
