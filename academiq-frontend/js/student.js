...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Tabs
  var TABS = [{key:'overview',label:'Dashboard'},{key:'timetable',label:'My Timetable'},{key:'instructors',label:'Instructors'},{key:'exams',label:'Exams'},{key:'ai',label:'AI Assistant'}];
